export default function Test({
  ...
  return (
    <div className={`${chosen ? 'bg-gray-200' : 'bg-white'} ${index % 2 === 0 ? 'text-green-900' : 'text-pink-900'} ${markBackground} ${markVisibility} justify-self-stretch grid text-s font-crimson-semi-bold p-1 w-5 hover:cursor-pointer`}>
